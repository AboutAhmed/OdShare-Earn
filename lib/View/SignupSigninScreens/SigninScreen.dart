...
import 'package:odshare_earn/View/SignupSigninScreens/SignupScreen.dart';
            ...
            children: <Widget>[
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => OnboardingScreen()), // Change NextScreen() to your next screen
                  );
                },
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    foregroundColor: Color(0xff0DA600), // Text color
                    padding: EdgeInsets.symmetric(vertical: 10.0), // Padding
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(5),
                      side: BorderSide(color: Color(0xff0DA600)),// Rounded corners
                    ),
                  ),
